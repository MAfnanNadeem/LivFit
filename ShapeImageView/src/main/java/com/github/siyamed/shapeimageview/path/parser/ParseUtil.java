...
class ParseUtil {
    ...
    static final String getStringAttr(String name, SimpleParser attributes) {
     ...
     */
    static final Float convertUnits(String name, SimpleParser atts, float dpi, float width, float height) {
