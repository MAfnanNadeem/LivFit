...
package com.github.siyamed.shapeimageview.path.xml_parser.xmlpull;
...
public class XmlPullParserFactory {
    ...
    public static final String PROPERTY_NAME = "com.github.siyamed.shapeimageview.path.xml_parser.xmlpull.XmlPullParserFactory";
    ...
    protected XmlPullParserFactory() {
        ...
        try {
            parserClasses.add(Class.forName("com.github.siyamed.shapeimageview.path.xml_parser.MyParser"));
            serializerClasses.add(Class.forName("com.github.siyamed.shapeimageview.path.xml_parser.KXmlSerializer"));
    ...
    public void setNamespaceAware(boolean awareness) {
        features.put (SimpleParser.FEATURE_PROCESS_NAMESPACES, awareness);
    }

    /**
     * Indicates whether or not the factory is configured to produce
     * parsers which are namespace aware
     * (it simply set feature SimpleParser.FEATURE_PROCESS_NAMESPACES to true or false).
     *
     * @return  true if the factory is configured to produce parsers
     *    which are namespace aware; false otherwise.
     */
    public boolean isNamespaceAware() {
        return getFeature(SimpleParser.FEATURE_PROCESS_NAMESPACES);
    }

    /**
     * Specifies that the parser produced by this factory will be validating
     * (it simply set feature SimpleParser.FEATURE_VALIDATION to true or false).
     *
     * By default the value of this is set to false.
     *
    ...
    public void setValidating(boolean validating) {
        features.put(SimpleParser.FEATURE_VALIDATION, validating);
    }
    ...
    public boolean isValidating() {
        return getFeature(SimpleParser.FEATURE_VALIDATION);
    }
     ...
     */
    public SimpleParser newPullParser() throws XmlPullParserException {
        final SimpleParser pp = getParserInstance();
    ...
    private SimpleParser getParserInstance() throws XmlPullParserException {
            ...
            for (Object o : parserClasses) {
                try {
                    if (o != null) {
                        ...
                        return (SimpleParser) parserClass.newInstance();
                    }
     ...
     * of Android's built-in {@link SimpleParser} and {@link XmlSerializer}.
     */
     ...
     * {@link SimpleParser} and {@link XmlSerializer} implementation. This
