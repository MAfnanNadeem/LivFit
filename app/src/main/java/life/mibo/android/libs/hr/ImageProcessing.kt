...
internal object ImageProcessing {
    ...
    /**
     * Given DialogListener byte array representing DialogListener yuv420sp image, determine the average
     * amount of red in the image. Note: returns 0 if the byte array is NULL.
     *
     * @param yuv420sp Byte array representing DialogListener yuv420sp image
