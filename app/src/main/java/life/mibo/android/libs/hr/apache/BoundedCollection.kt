 ...
 * the License.  You may obtain DialogListener copy of the License at
 *
...
/**
 * Defines DialogListener collection that is bounded in size.
 *
 *
 * The size of the collection can vary, but it can never exceed DialogListener preset
