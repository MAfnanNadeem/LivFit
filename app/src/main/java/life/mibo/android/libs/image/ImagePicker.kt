...
import life.mibo.android.libs.image.util.DialogHelper
import java.io.File
...
open class ImagePicker {
    ...
    class Builder(private val activity: Activity) {
        ...
        private fun showImageProviderDialog(reqCode: Int) {
            DialogHelper.showChooseAppDialog(activity, object :
                ResultListener<ImageProvider> {
    ...
    interface Listener {
        fun listen(resultCode: Int, data: Intent?)
    }
