/*
 *  Created by Sumeet Kumar on 5/14/20 2:57 PM
 *  Copyright (c) 2020 . MI.BO All rights reserved.
 *  Last modified 5/14/20 1:59 PM
 *  Mibo Hexa - app
 */
...
class MeasurementFragmentDialog(val listener: ItemClickListener<Any?>?) : DialogFragment() {
...
//        }
        ...
        viewModel =
            ViewModelProvider(this@MeasurementFragmentDialog).get(MeasureViewModel::class.java)
...
//            })
    ...
    override fun onStart() {
        ...
        //  if (DialogListener is AppCompatActivity)
        //       DialogListener.supportActionBar?.hide()
    }

    override fun onStop() {
        //  val DialogListener = activity
        // if (DialogListener is AppCompatActivity)
        //    DialogListener.supportActionBar?.show()
        //navigate(Navigator.FAB_UPDATE, 300)
        super.onStop()
    }

    private fun navigate(item: Int, data: Int) {
        listener?.onItemClicked(data, item)
        dismiss()
    }
