...
data class HomeItem(
    ...
    enum class Type {
        HEART, WEIGHT, CALORIES, PROFILE, SERVICES, PROFILE_UPLOAD, CALENDAR, PROGRAMS, EXERCISE, RXL, BOOSTER_SCAN, WEATHER, RXL_SCAN, TILES, FLOOR, UNKNOWN, ADD, SCHEDULE, STEPS, RXL_TEST, MEASURE, MY_ACCOUNT, MY_SERVICES, MEASURE_NEW, CENTER_BUTTON
    }
