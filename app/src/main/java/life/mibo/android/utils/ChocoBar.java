...
public class ChocoBar {
    ...
    public static void snackbar(Activity activity, String msg) {
    ...
    Drawable makeTransparentDrawable(Context context, int width, int height) {
    ...
    private Snackbar make() {
        ...
        if (builder.icon != null) {
            ...
            text.setCompoundDrawablePadding(text.getResources().getDimensionPixelOffset(R.dimen.grid_2x));
        }
