...
public class AppSignatureHelper extends ContextWrapper {
    ...
    //pkg: life.mibo.hexa.debug -- hash: O2KCiTrZWLq
    //pkg: life.mibo.hexa -- hash: 0EWrrEaRqvE
    //0EWrrEaRqvE O2KCiTrZWLq
    private static String hash(String packageName, String signature) {
        Log.e(TAG, String.format("pkg: %s -- signature: %s", packageName, signature));
