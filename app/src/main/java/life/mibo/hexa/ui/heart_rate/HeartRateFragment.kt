...
//        recyclerView?.adapter = adapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, bundle: Bundle?):
            View? {
        val root = inflater.inflate(life.mibo.hexa.R.layout.fragment_heart_rate, container, false)
        tabLayout = root.findViewById(life.mibo.hexa.R.id.tabLayout)
        viewPager2 = root.findViewById(life.mibo.hexa.R.id.viewPager2)
