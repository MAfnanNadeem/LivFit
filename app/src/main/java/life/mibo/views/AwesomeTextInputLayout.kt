/*
 *  Created by Sumeet Kumar on 5/30/20 3:33 PM
 *  Copyright (c) 2020 . MI.BO All rights reserved.
 *  Last modified 5/30/20 3:33 PM
 *  Mibo Hexa - app
 */
    ...
    private fun initAttrs(attributeSet: AttributeSet) {
        with(
            ...
            cornerRadius = getDimension(
                R.styleable.AwesomeTextInputLayout_cornerRadius2,
                cornerRadius
            )
            animationDuration = getInteger(
                R.styleable.AwesomeTextInputLayout_animationDuration2,
                animationDuration
            )
        }
    }
