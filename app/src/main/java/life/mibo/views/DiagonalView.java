/*
 *  Created by Sumeet Kumar on 2/15/20 10:25 AM
 *  Copyright (c) 2020 . MI.BO All rights reserved.
 *  Last modified 2/15/20 10:25 AM
 *  Mibo Hexa - app
 */
...
public class DiagonalView extends AppCompatImageView {
    ...
    private DiagonalHelper.Gravity gravity = DiagonalHelper.Gravity.BOTTOM;
    private DiagonalHelper.Direction direction = DiagonalHelper.Direction.LEFT_TO_RIGHT;
    ...
    private void init(Context context, AttributeSet attributeSet, int defStyleAttr) {
        if (attributeSet != null) {
            ...
            gravity =DiagonalHelper.GRAVITIES[array.getInt(R.styleable.DiagonalView_gravity, 3)];
            ...
            direction = DiagonalHelper.DIRECTIONS[array.getInt(R.styleable.DiagonalView_diagonalDirection, 0)];
            array.recycle();
        }
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
        Path path = DiagonalHelper.getPathFor(getWidth(), getHeight(), angle, direction, gravity);
        if (bitmap != null) {
    ...
    public void setDiagonalGravity(DiagonalHelper.Gravity gravity) {
        this.gravity = gravity;
        invalidate();
    }

    public void setDiagonalDirection(DiagonalHelper.Direction direction) {
