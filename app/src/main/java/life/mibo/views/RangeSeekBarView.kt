/*
 *  Created by Sumeet Kumar on 3/5/20 4:08 PM
 *  Copyright (c) 2020 . MI.BO All rights reserved.
 *  Last modified 3/5/20 4:08 PM
 *  Mibo Hexa - app
 */
...
class RangeSeekBarView : AppCompatSeekBar, SeekBar.OnSeekBarChangeListener {
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        if (typedArray.hasValue(R.styleable.RangeSeekBarView_seekBarHeight)) {
            barHeight =
                typedArray.getDimensionPixelSize(R.styleable.RangeSeekBarView_seekBarHeight, 0)
        }
        ...
        if (typedArray.hasValue(R.styleable.RangeSeekBarView_circleTextColor)) {
            circleTextColor =
                typedArray.getColor(R.styleable.RangeSeekBarView_circleTextColor, Color.RED)
        }
        ...
        if (typedArray.hasValue(R.styleable.RangeSeekBarView_seekBarFillColor)) {
            fillColor =
                typedArray.getColor(R.styleable.RangeSeekBarView_seekBarFillColor, Color.BLACK)
        }
        this.max = 100
    ...
    private fun drawBar(canvas: Canvas) {
        ...
        val percentFilled =
            calculateProgress(valueToDraw.toInt(), minValue, maxValue).toFloat() / max
    ...
    override fun onProgressChanged(seekBar: SeekBar, progress: Int, fromUser: Boolean) {
        ...
        listener?.onProgressChanged(this@RangeSeekBarView, displayValue, fromUser)
    }

    override fun onStopTrackingTouch(seekBar: SeekBar) {
        listener?.onStopTrackingTouch(this@RangeSeekBarView)

    }

    override fun onStartTrackingTouch(seekBar: SeekBar) {
        listener?.onStartTrackingTouch(this@RangeSeekBarView)

    }

    fun setListener(l: OnRangeSeekBarChangeListener) {
        listener = l
    }
