...
class BackdropLayout @JvmOverloads constructor(context: Context, attribute : AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    var menuIcon : Int = R.drawable.ic_filter_menu
    var closeIcon : Int = R.drawable.ic_cancel_circle
    var duration   = DEFAULT_DURATION

    /**
     * navigator : will be called when ever
    ...
    init {
        ...
        menuIcon = typedArray.getResourceId(R.styleable.BackdropLayout_menuDrawable,R.drawable.ic_filter_menu)
        disableWhenOpened = typedArray.getBoolean(R.styleable.BackdropLayout_disable_when_open , true)
        closeIcon = typedArray.getResourceId(R.styleable.BackdropLayout_closeDrawable,R.drawable.ic_cancel_circle)
    ...
    fun getFrontLayout() : View {
        ...
        frontLayout = findViewById(frontLayoutId) ?: throw Exception("please provide DialogListener valid id for front layout")
        return frontLayout!!
    }

    fun getBackLayout() : View {
        if(backLayout != null) return backLayout!!
        backLayout = findViewById(backLayoutId) ?: throw Exception("please provide DialogListener valid id for back layout")
        return backLayout!!
    }

    fun bindToolbar(t: Toolbar)
    {
        this.toolbar = t
    }
