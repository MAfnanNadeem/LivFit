        ...
        if (attributeSet != null) {
            ...
            try { //Parse params
                ...
                if (a.hasValue(R.styleable.RulerValuePicker_rv_long_height_height_ratio)) {
                    mLongIndicatorHeightRatio = a.getFraction(R.styleable.RulerValuePicker_rv_long_height_height_ratio,
                            1, 1, 0.6f);
                }
                if (a.hasValue(R.styleable.RulerValuePicker_rv_short_height_height_ratio)) {
                    mShortIndicatorHeightRatio = a.getFraction(R.styleable.RulerValuePicker_rv_short_height_height_ratio,
                            1, 1, 0.4f);
                }
