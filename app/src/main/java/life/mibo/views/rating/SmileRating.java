/*
 *  Created by Sumeet Kumar on 5/21/20 1:53 PM
 *  Copyright (c) 2020 . MI.BO All rights reserved.
 *  Last modified 5/21/20 1:53 PM
 *  Mibo Hexa - app
 */

package life.mibo.views.rating;
...
//    private Path mEyePathRight = new Path();
    ...
    private boolean defAnimate = true;
    ...
    private void positionSmile() {
        ...
        setSelectedSmile(smile, point, false, defAnimate);
    }
        ...
        for (Integer smile : mTouchPoints.keySet()) {
            ...
            if (touched) {
                if (smile == getSelectedSmile()) {
                    ...
                    setSelectedSmile(smile, point, true, defAnimate);
                }
            }
        }
    }
