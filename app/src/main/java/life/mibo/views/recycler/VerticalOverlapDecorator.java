...
public class
VerticalOverlapDecorator extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        //the number of the items in DialogListener small row
        ...
        Log.e("VerticalDecorator", "getItemOffsets: "+outRect.toString() );
        ...
        Log.e("VerticalDecorator", "getItemOffsets2: "+outRect.toString() );
