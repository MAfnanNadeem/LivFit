/*
 *  Created by Sumeet Kumar on 2/13/20 12:23 PM
 *  Copyright (c) 2020 . MI.BO All rights reserved.
 *  Last modified 2/13/20 12:23 PM
 *  Mibo Hexa - app
 */
package life.mibo.views.text;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.expand_layout, this, true);
        ...
        mStateTvGravity = STATE_TV_GRAVITY_RIGHT;
        mExpandString = "..Read More";
        mCollapsedString = ".. Read Less";
        mStateTextColor = Color.BLACK;
    ...
    private void findViews() {
        ...
        mTv.setTextSize(TypedValue.COMPLEX_UNIT_SP, mContentTextSize);
