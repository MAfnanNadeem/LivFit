...
import life.mibo.imagepicker.utils.ModelUtils;
import life.mibo.imagepicker.utils.StorageUtils;
...
//    }
    ...
    public RxGalleryFinal single() {
        configuration.setSingle(true);
        return this;
    }

    public RxGalleryFinal multiple() {
        configuration.setSingle(false);
        return this;
    }
    ...
    public RxGalleryFinal freeStyleCrop(boolean enabled) {
