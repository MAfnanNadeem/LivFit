...
import life.mibo.imagepicker.ui.RxGalleryListener;
...
//https://github.com/topics/android-image-cropper
//https://github.com/topics/cropper

public class RxGalleryFinalApi {
    public static final String FOLDER_NAME = "/DCIM/MIBO/";
    public static final String IMAGE_NAME = "mibo_%s.jpg";
    public static final int TAKE_IMAGE_REQUEST_CODE = 19001;
    public static File fileImagePath;//Take a picture
    public static File cropImagePath;//Crop picture
    ...
    public static int openZKCamera(Object activity) {
        ...
        if (captureIntent.resolveActivity(cameraActivity.getPackageManager()) != null) {
            ...
            File mImageStoreDir = new File(Environment.getExternalStorageDirectory(), FOLDER_NAME);
    ...
    public static String getModelPath() {
        ...
        try {
            String imageName = "mibo_%s_%s.jpg";
