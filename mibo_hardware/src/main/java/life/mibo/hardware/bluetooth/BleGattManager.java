...
public class BleGattManager {
    ...
    public static UUID HEART_RATE_2902= UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");
    public static UUID HEART_RATE_BATTERY_SERVICE= UUID.fromString("0000180f-0000-1000-8000-00805f9b34fb");
    public static UUID HEART_RATE_BATTERY= UUID.fromString("00002A19-0000-1000-8000-00805f9b34fb");
