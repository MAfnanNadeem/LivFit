...
public class RxlTapEvent {
    ...
    public RxlTapEvent(byte[] command, String uid) {
        this.command = command;
        this.uid = uid;

    }

    public RxlTapEvent(int type, byte[] command, String uid) {
        this.type = type;
        this.command = command;
        this.uid = uid;
    ...
    public RxlTapEvent(byte[] command, String uid, int data) {
        this.command = command;
        this.uid = uid;
        this.data = data;
