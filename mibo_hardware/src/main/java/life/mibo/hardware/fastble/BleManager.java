/*
 *  Created by Sumeet Kumar on 3/19/20 9:16 AM
 *  Copyright (c) 2020 . MI.BO All rights reserved.
 *  Last modified 3/19/20 5:13 PM
 *  Mibo Hexa - mibo_hardware
 */

package life.mibo.hardware.fastble;
...
import life.mibo.hardware.fastble.bluetooth.MultipleBluetoothController;
import life.mibo.hardware.fastble.bluetooth.SplitWriter;
...
import life.mibo.hardware.fastble.callback.BleRssiCallback;
...
import life.mibo.hardware.fastble.data.BleScanState;
...
//        }
     ...
     * @param callback
     */
    public void notify(BleDevice bleDevice, String uid,
                       String uuid_service,
                       String uuid_notify,
    ...
    public BleDevice getBleDevice(String uid) {
        if (multipleBluetoothController != null) {
            return multipleBluetoothController.getBleDevice(uid);
        }
        return null;
    }
    ...
    public void clearAll() {
        if (multipleBluetoothController != null) {
            for (BleBluetooth b : multipleBluetoothController.getBleBluetoothList()) {
                if (b != null)
    ...
    public ArrayList<BluetoothDevice> getAllConnectedBluetooths() {
        if (multipleBluetoothController == null)
            return null;
        return multipleBluetoothController.getBluetoothDeviceList();
    }
