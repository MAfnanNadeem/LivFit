...
import life.mibo.hardware.fastble.data.BleWriteState;
import life.mibo.hardware.fastble.exception.GattException;
...
public class BleConnector {
    ...
    private life.mibo.hardware.fastble.bluetooth.BleBluetooth mBleBluetooth;
    private Handler mHandler;
    private String uid = "";

    BleConnector(BleBluetooth bleBluetooth, String uid) {
        this(bleBluetooth);
        this.uid = uid;
    }
